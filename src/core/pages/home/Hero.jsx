...
const Hero = () => {
  return (
    <>
      <span className="[&>svg]:h-[80vh] [&>svg]:absolute [&>svg]:-z-10 [&>svg]:m-auto [&>svg]:block [&>svg]:w-full">
        <svg
      ...
      <div className="h-[70vh] mt-[80px] w-100 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32">
        <div className="text-center">
          ...
          >
            <h1 className="mt-6 mb-16 text-pink-400 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl">
              The best{" "}
              <span className="text-fuchsia-900">printing service </span> <br />
              <span className="text-primary">on the market</span>
            </h1>
            <button
